...
# st.write('This app predicts if a customer will churn or not based on their demographics and behavior.')
...
input_df = pd.concat([input_data.reset_index(drop=True), geo_encode_df], axis=1)
